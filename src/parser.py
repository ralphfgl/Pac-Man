    ...
    def validate(self, data: dict[str, Any]) -> Config:
        ...
        try:
            ...
            for missing_key in missing_keys:
                ...
                print(
                    f"[INFO] - Key '{missing_key}' is missing, using default value: {default_value}",
                    file=sys.stderr,
                )
            ...
            for err in e.errors():
                ...
                print(
                    f"[STDERR] - Invalid config field {key}, using default value: {getattr(defaults, key)}",
                    file=sys.stderr,
                )
...
if __name__ == "__main__":
    ...
    print("\nPoints")
    print(
        f" Pacgum, super pacgum, ghost: {config.points_per_pacgum}, {config.points_per_super_pacgum}, {config.points_per_ghost}"
    )
